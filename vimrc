...
" Version: 
"       1.0 - 04/01/2019 
"       modification based on https://github.com/amix/vimrc
"
" Sections:
"    -> General
"    -> VIM user interface
...
"    -> Misc
"    -> Helper functions
"    -> config for Plugins (this section needs organization)
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
set statusline=\ %{HasPaste()}%r%{getcwd()}%h\ \ \ Line:\%l/%L\ \ Column:\%c\ (%P)
"set statusline=%{HasPaste()}%F%m%r%h\ %w\ Line:%l\ Column:%c\ (%P)\ %{buftabs#statusline()} 
